...
darkmodeBtn.addEventListener("click", () => {
    ...
    if (darkmodeBtn.classList.contains("btn-dark")) {
        ...
        pageBody.style.background = "linear-gradient(90deg, rgba(172, 255, 211, 1) 0%, rgba(229, 229, 229, 1) 50%, rgba(229, 229, 229, 1) 100%)";
        headings.classList.add("text-dark");
    } else {
        darkmodeBtn.style.backgroundImage = `url("../images/sun.svg")`;
        pageBody.style.background = "linear-gradient(90deg, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 1) 50%, rgba(0, 39, 18, 1) 100%)";
